package com.sducsrp.csrp.controller.ToolsController.RC4;
...
public class RC4 {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        RC4 rc4=new RC4();
        String encryStr = rc4.encryRC4String("测试hahah", "123456","UTF-8");
        System.out.println("加密后得到得字符串："+encryStr);
        String decryStr = rc4.decryRC4(encryStr, "123456","UTF-8");
        System.out.println("解密后得到得字符串："+decryStr);
    }
}