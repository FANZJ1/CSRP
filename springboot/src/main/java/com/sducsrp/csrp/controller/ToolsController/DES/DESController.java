package com.sducsrp.csrp.controller.ToolsController.DES;
...
public class DESController {
    ...
    // DES加密
    @GetMapping("/encrypto")
    public Result encrypto(@RequestParam() String clearText,@RequestParam() String originKey)throws NoSuchPaddingException,
...
//        SecretKeySpec key = getKey(originKey);
    ...
    // DES解密
    @GetMapping("/decrypto")
    public Result decrypto(@RequestParam() String cipherText,@RequestParam() String originKey)throws NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
...
//        SecretKeySpec key = getKey(originKey);
        ...
        return Result.success(new String(doFinal));
    }
     ...
     */
    private static String desEncript(String clearText, String originKey) throws NoSuchPaddingException,
            NoSuchAlgorithmException,InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
     ...
     * @throws IllegalBlockSizeException
     */
    private static String desDecript(String cipherText, String originKey) throws NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        Cipher cipher = Cipher.getInstance("DES");
        SecretKeySpec key = getKey(originKey);
        cipher.init(Cipher.DECRYPT_MODE,key);
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, BadPaddingException,
         ...
         * */
        String clearText = "21314142";//明文
        String originKey = "1";//原始密钥
