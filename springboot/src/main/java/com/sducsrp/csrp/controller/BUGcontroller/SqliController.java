...
import com.sducsrp.csrp.entity.Bugentity.sqliuser;
...
//            String[] resultName = new String[row];
//            String[] resultID = new String[row];
//            String[] resultLevel = new String[row];
//            String result1 = "";
            int count = 0;
            rs.next();
