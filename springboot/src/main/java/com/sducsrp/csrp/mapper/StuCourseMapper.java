...
import com.sducsrp.csrp.entity.StuCourse;
...
public interface StuCourseMapper extends BaseMapper<StuCourse> {
    ...
    // 分页查找
    @Select("select user.userid ,username,realname,phone,finished from  stucourse, user where stucourse.userid =user.userid and" +
