...
<!--    <h1 style="color: white">flag就藏在sqlifl4g表中哦~</h1>-->
  ...
  <div style="margin-top: 5%">
    <el-input v-model="id"
              style="width: 40%;
              margin-right: 50px;"
              placeholder="请输入学号ID"></el-input>
    <el-button @click="pingfun"
               type="info"
               plain>查找</el-button>
  </div>

<!--  <el-card v-if="show==1" style="width: 50%;margin-left: 25%;margin-top: 5%;word-break:break-all">-->
  <el-card class="card"
           style="width: 50%;
           margin-left: 25%;
           margin-top: 4%;
