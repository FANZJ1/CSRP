<!--题目名字：Over Permission-水平越权-->
<!--题目类型：逻辑越权漏洞-->
<!--题目描述：尝试登录到个人中心，测试水平越权漏洞（user1：123，123；user2：lc，123）-->
<!--题目难度：2星-->
<template>
  <div class="line"></div>
  <el-menu
...
<!--                  <el-table :data="myresult" border="true" style="">-->
<!--                    <el-table-column prop="username" label="用户名" />-->
<!--                    <el-table-column prop="phone" label="联系电话" />-->
<!--                    <el-table-column prop="add" label="通信地址" />-->
<!--                  </el-table>-->
<!--                </el-card>-->
              </el-col>
            </el-card>
...
export default {
  ...
  methods:{
    // getusername(){
    //   request.get("/op1/person_center/getusername",{
    //     params:{
    //       //filename:'flag.txt'
    //      // username:''
    //     }
    ...
    //     this.getperson_information(this.myresult);
    //   })
    // },
    getperson_information(){
      ...
      request.get("/op1/person_center/information",{
        ...
        //alert(res.data)
        // this.myinformation=res.data.split(",")
        // res.data
        // this.myresult=res.data;
