...
<!--  <input type="button" value="跳转到登录界面"-->
<!--      onclick="javascrtpt:window.location.href='http://localhost:8080/url_redirect?url=www.baidu.com'" />-->
    ...
    methods: {
      redirect() {
        request.get("/url_redirect",{
          ...
          alert(res.data)
          window.location.href='http://localhost:8080/pro001';
...
<!--对于安全意识较低的用户，当他们从聊天工具、论坛回帖等地方遇到上述链接时，根据链接的开头部分用户会认为打开之后是aaa公司的业务，-->
<!--尤其当www.aaa.com是耳熟能详的大型互联网公司时，用户的防备心理会更小，打开之后无论怎么跳转，用户都可能认为是值得信任的，-->
<!--当www.evil.com是钓鱼页面时，用户也可能毫不犹豫地输入用户名和密码登录网站。-->
<!--<br>-->
<!--<input type="button" value="跳转到登录界面"-->
<!--       onclick="javascrtpt:window.location.href='http://localhost:8080/url_redirect?url=www.baidu.com'" />-->
