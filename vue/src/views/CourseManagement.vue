<template>
  <div class="management" style="padding-bottom: 5px;background-color: rgba(255,255,255,0.8)" :style="{ height: windowHeight + 'px' }">
    ...
    <div style="margin-top: 20px">
      ...
      <el-button type="primary" plain style="margin: 10px" @click="addcourse">新建班级</el-button>
    </div>
        ...
        <el-card  style="width:90%;margin-top:3%;margin-right:10%;">
          ...
          <div class="btngroup" style="width: 100%;">
            ...
            <span style="float: right; margin-bottom:10px">
              ...
              <el-button type="success" plain @click="Dissolve">解散班级</el-button>
            </span>
          </div>
          <!--      卡片表格-->
          <div class="table-wrapper" >
            <el-table :data="tableData" border="true" style="width: 100%;">
              ...
              <el-table-column label="靶场完成度" prop="finished">
              ...
              <el-table-column  label="操作" width="180">
                <template #default="scope">
                  <el-button type="info" plain @click="studetails(scope.row.username)">详情</el-button>
                  <el-button type="info" plain @click="deletethis(scope.row.username)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination
...
<script>
import Sduheader from "@/components/sduheader";
import request from "@/utils/request";
import csrpqrcode from '../components/csrpQRCode'
