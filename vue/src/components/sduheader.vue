...
<!--        <h3  style="margin-left: 40%;">SDUCSRP</h3>-->
      ...
      <el-col :span="13">
        <el-menu
            ...
            @select="handleSelect"
        >
          <el-menu-item v-if="user.role !=3" index="/honeypot" @click="goto_honeypot"> CTF靶场 </el-menu-item>
          <el-menu-item v-if="user.role !=3" index="/abilitypromotion" @click="goto_abilitypromotion">能力提升</el-menu-item>
...
export default {
  ...
  methods: {
    ...
    goto_abilitypromotion(){
      router.push('/abilitypromotion')
    },
    goto_navigation(){
