...
<!--        <div style="width: 80%;margin-left: 10%;height: 80%;margin-top: 5%;color: black">-->
<!--          <h1 style="font-family: 宋体;font-size: 35px;">类型介绍</h1>-->
<!--          <p style="text-align: left; height: 35px; font-size: 15px; line-height: 40px;">-->
<!--            {{introduction}}-->
<!--          </p>-->
<!--        </div>-->
      ...
      <el-col :span="11">
        <div style="margin-top: 10%;">
          ...
          <div class="select" >
            ...
            <el-button class="btn-group"  type="info" @click="getprobleminfo('csrf')"> CSRF</el-button>
  ...
  data(){
    return{
      ...
      introimglist:{
        ...
        force:require('@/assets/img/force.jpg'),
